...
export default function Hero() {
  ...
  const specialTodos = async () => {
    ...
    const q = query(colRef, where("courses", "==", "Arts"))
        ...
        <div className="text-center" style={{ display: "flex" }} id='fullpage'>
          <div className="row">
            <div className="col mt-2 align-items-center justify-content-center d-flex">
              <div className="row">
                <div className="col">
                  <h1 className='text-center'>Arts <span>({documents.length})</span></h1>
                </div>
              </div>
            </div>
          </div>
            ...
            return (
              <div className="col" key={i}>
                <div className="card mt-4" style={{ backgroundColor: document.backgroundColor }}>
                  <div className="card boxShadow " style={{ height: '260px', backgroundColor: "black" }}>
